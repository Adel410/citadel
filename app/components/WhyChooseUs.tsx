...
const features = [
  {
    ...
    description: "Une expérience solide dans la protection des entreprises",
    icon: (
  ...
  },
  {
    ...
    description: "Experts CISSP, CEH, OSCP à votre service",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="bg-slate-800/50 p-6 rounded-lg border border-slate-700 hover:border-cyan-500 transition-all duration-300"
            >
